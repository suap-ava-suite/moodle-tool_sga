...
/**
 * Chaînes de langue françaises pour tool_sga.
 *
 * @package     tool_sga
 * @category    string
...
$string['pluginname'] = 'Intégrateur SGA';
...
$string["default_user_preferences"] = "Préférences par défaut de l'utilisateur";
$string["default_user_preferences_desc"] = "Chaque nouvel utilisateur (étudiant ou enseignant) aura ces préférences. Utilisez une ligne par préférence, comme dans un fichier .ini.";

$string["sync_up_enrolments_task"] = "Intégrateur SGA : synchroniser les inscriptions en arrière-plan";
