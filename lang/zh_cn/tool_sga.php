...
$string["default_user_preferences"] = '用户默认偏好设置';
$string["default_user_preferences_desc"] = '每个新用户（学生或教师）都将拥有这些偏好设置。每行一个偏好设置，格式类似 .ini 文件。';

$string["sync_up_enrolments_task"] = 'SGA 集成器：后台同步注册信息';
